                ...
                <div class="product">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <div id="prod-pager">
                                <a data-slide-index="0" href="">
                                    <div class="prod-pager-thumb" style="background-image: url(assets/uploads/<?php echo $photos; ?>"></div>
                                </a>
                                <?php
                                $i = 1;
                                $statement = $pdo->prepare("SELECT * FROM tbl_p_photo WHERE p_id=?");
                                ...
                                ?>
                                    <a data-slide-index="<?php echo $i; ?>" href="">
                                        <div class="prod-pager-thumb" style="background-image: url(assets/uploads/autre_photosd/<?php echo $row['photo']; ?>"></div>
                                    </a>
                                <?php
                                    $i++;
                                }
                        ...
                        <div class="col-md-7">
                            ...
                            ?>
                                <div class="p-title"><?php echo $row2['prenom_c']; ?></h2>
                                </div>
                            <?php
                            }
                            ?>
